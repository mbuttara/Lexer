...
static const char *const yytname[] =
{
  ...
  "\"NewArray\"", "\"Print\"", "\"ReadInteger\"", "\"ReadLine\"", "T_LE",
  "T_GE", "T_EQ", "T_NEQ", "T_AND", "T_OR", "T_ARRAY", "T_BOOLLITERAL",
  "T_INTLITERAL", "T_DBLLITERAL", "T_STRINGLITERAL", "T_TYPEIDENTIFIER",
  "T_IDENTIFIER", "$accept", "pgm", "program", YY_NULLPTR
};
#endif
